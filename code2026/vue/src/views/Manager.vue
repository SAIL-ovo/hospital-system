    ...
    <div style="height: 60px; background-color: #2e3143; display: flex; align-items: center; border-bottom: 1px solid #ddd">
      <div style="flex: 1">
        <div style="padding-left: 20px; display: flex; align-items: center">
          ...
          <div style="font-weight: bold; font-size: 24px; margin-left: 5px; color: #fff">xx区xx街-社区医院</div>
        </div>
      </div>
      ...
      <div style="width: 200px; border-right: 1px solid #ddd; min-height: calc(100vh - 60px)">
        ...
        >
          ...
          <el-sub-menu index="info">
            ...
            <el-menu-item index="/manager/assessment">
              <el-icon><OfficeBuilding /></el-icon>
              <span>评测题目信息</span>
            </el-menu-item>
            <el-menu-item index="/manager/inquiry-record">
          ...
          <el-sub-menu index="user">
            ...
            <el-menu-item index="/manager/doctor">
