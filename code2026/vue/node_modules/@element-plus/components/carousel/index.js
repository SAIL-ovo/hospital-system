...
function render$1(_ctx, _cache, $props, $setup, $data, $options) {
  return withDirectives((openBlock(), createBlock("div", {
    ...
    _ctx.type === "card" ? withDirectives((openBlock(), createBlock("div", _hoisted_1$1, null, 512)), [
...
script$1.__file = "packages/components/carousel/src/item.vue";

script.install = (app) => {
  app.component(script.name, script);
  app.component(script$1.name, script$1);
};
script.CarouselItem = script$1;
const _Carousel = script;
const ElCarousel = _Carousel;
const ElCarouselItem = script$1;
