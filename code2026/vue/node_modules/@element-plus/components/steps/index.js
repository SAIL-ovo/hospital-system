import { defineComponent, ref, watch, provide, openBlock, createBlock, renderSlot, inject, getCurrentInstance, onMounted, onBeforeUnmount, computed, reactive, createCommentVNode, createVNode, toDisplayString, createTextVNode } from 'vue';
...
script$1.__file = "packages/components/steps/src/item.vue";

script.install = (app) => {
  app.component(script.name, script);
  app.component(script$1.name, script$1);
};
script.Step = script$1;
const _Steps = script;
const ElSteps = _Steps;
const ElStep = script$1;
