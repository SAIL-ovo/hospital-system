import { defineComponent, openBlock, createBlock, createVNode, resolveComponent, createCommentVNode, computed, mergeProps, Fragment, renderList, renderSlot } from 'vue';
...
script$2.__file = "packages/components/skeleton/src/index.vue";

script$2.install = (app) => {
  app.component(script$2.name, script$2);
  app.component(script$1.name, script$1);
};
script$2.SkeletonItem = script$1;
const _Skeleton = script$2;
const ElSkeleton = _Skeleton;
const ElSkeletonItem = script$1;
