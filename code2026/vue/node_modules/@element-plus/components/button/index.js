...
const _hoisted_1$1 = { class: "el-button-group" };
...
script$1.__file = "packages/components/button/src/button-group.vue";

script.install = (app) => {
  app.component(script.name, script);
  app.component(script$1.name, script$1);
};
script.ButtonGroup = script$1;
const _Button = script;
const ElButton = _Button;
const ElButtonGroup = script$1;
