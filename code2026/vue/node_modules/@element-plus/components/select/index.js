...
import { useLocaleInject, useFocus } from '@element-plus/hooks';
...
import { getValueByPath, escapeRegexpString, useGlobalConfig, isIE, isEdge } from '@element-plus/utils/util';
...
script$1.__file = "packages/components/select/src/select-dropdown.vue";
...
script$2.__file = "packages/components/select/src/select.vue";
...
const _hoisted_1$1 = { class: "el-select-group__wrap" };
const _hoisted_2$1 = { class: "el-select-group__title" };
const _hoisted_3$1 = { class: "el-select-group" };
function render$3(_ctx, _cache, $props, $setup, $data, $options) {
  return withDirectives((openBlock(), createBlock("ul", _hoisted_1$1, [
    createVNode("li", _hoisted_2$1, toDisplayString(_ctx.label), 1),
    createVNode("li", null, [
...
script$3.__file = "packages/components/select/src/option-group.vue";
...
script$2.Option = script;
script$2.OptionGroup = script$3;
const _Select = script$2;
const ElSelect = _Select;
const ElOption = script;
const ElOptionGroup = script$3;

export default _Select;
export { ElOption, ElOptionGroup, ElSelect, selectEvents, selectGroupKey, selectKey };
