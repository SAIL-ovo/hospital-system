import { getCurrentInstance, ref, unref, computed, watch, nextTick, isRef, defineComponent, resolveComponent, resolveDirective, openBlock, createBlock, withCtx, createVNode, Fragment, renderList, createTextVNode, toDisplayString, withDirectives, onBeforeMount, onMounted, onUpdated, onUnmounted, h, watchEffect, renderSlot, createCommentVNode, vShow, onBeforeUnmount } from 'vue';
import debounce from 'lodash/debounce';
import { ClickOutside, Mousewheel } from '@element-plus/directives';
import { useLocaleInject } from '@element-plus/hooks';
import { getValueByPath, arrayFind, arrayFindIndex, useGlobalConfig, getPropByPath } from '@element-plus/utils/util';
import { hasOwn } from '@vue/shared';
import { createPopper } from '@popperjs/core';
import PopupManager from '@element-plus/utils/popup-manager';
import { off, on, addClass, hasClass, removeClass, getStyle } from '@element-plus/utils/dom';
...
var ElTableColumn = defineComponent({
  ...
  setup(props, { slots }) {
    ...
    onBeforeMount(() => {
      ...
      const defaults = __spreadProps$2(__spreadValues$5({}, cellStarts[type]), {
        id: columnId.value,
        type,
...
script$1.TableColumn = ElTableColumn;
const _Table = script$1;
const ElTable = _Table;
const ElTableColumn$1 = ElTableColumn;

export default _Table;
export { ElTable, ElTableColumn$1 as ElTableColumn };
