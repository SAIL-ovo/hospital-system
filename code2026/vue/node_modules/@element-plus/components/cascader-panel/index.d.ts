...
declare const _CascaderPanel: SFCWithInstall<import("vue").DefineComponent<{
    ...
    handleCheckChange: (node: import("./src/node").default, checked: boolean, emitClose?: boolean) => void;
    ...
    modelValue?: import("./src/node").CascaderValue;
    renderLabel?: import("./src/node").RenderLabel;
}>, {
    props: import("./src/node").CascaderProps;
    border: boolean;
    options: import("./src/node").CascaderOption[];
