import { inject, computed, ref, defineComponent, getCurrentInstance, watch, provide, onMounted, resolveComponent, openBlock, createBlock, withCtx, createVNode, renderSlot, createCommentVNode, resolveDirective, withDirectives, withModifiers } from 'vue';
import ElButton from '@element-plus/components/button';
import ElPopper from '@element-plus/components/popper';
import ElScrollbar from '@element-plus/components/scrollbar';
import { addClass, on, removeClass } from '@element-plus/utils/dom';
import { useGlobalConfig, generateId, addUnit } from '@element-plus/utils/util';
...
script$2.__file = "packages/components/dropdown/src/dropdown-menu.vue";

script.install = (app) => {
  app.component(script.name, script);
};
script.DropdownItem = script$1;
script.DropdownMenu = script$2;
const _Dropdown = script;
const ElDropdown = _Dropdown;
const ElDropdownItem = script$1;
const ElDropdownMenu = script$2;
