import { inject, computed, ref, getCurrentInstance, watch, defineComponent, openBlock, createBlock, createVNode, withDirectives, vModelCheckbox, renderSlot, Fragment, createTextVNode, toDisplayString, createCommentVNode, provide, toRefs, nextTick } from 'vue';
...
script$2.__file = "packages/components/checkbox/src/checkbox-group.vue";
...
script.CheckboxButton = script$1;
script.CheckboxGroup = script$2;
const _Checkbox = script;
const ElCheckbox = _Checkbox;
const ElCheckboxButton = script$1;
const ElCheckboxGroup = script$2;

export default _Checkbox;
export { ElCheckbox, ElCheckboxButton, ElCheckboxGroup };
