...
declare const _Space: SFCWithInstall<import("vue").DefineComponent<{
    ...
    size: {
        type: import("vue").PropType<number | import("@element-plus/utils/types").ComponentSize | [number, number]>;
        validator: (val: unknown) => boolean;
    };
}, {
    ...
    style?: unknown;
    size?: number | import("@element-plus/utils/types").ComponentSize | [number, number];
    prefixCls?: string;
