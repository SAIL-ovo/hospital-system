import { defineComponent, inject, getCurrentInstance, ref, watch, nextTick, openBlock, createBlock, computed, onUpdated, onMounted, onBeforeUnmount, h, provide, Fragment, withDirectives, renderSlot, vShow, createCommentVNode } from 'vue';
...
script$2.__file = "packages/components/tabs/src/tab-pane.vue";

Tabs.install = (app) => {
  app.component(Tabs.name, Tabs);
  app.component(script$2.name, script$2);
};
Tabs.TabPane = script$2;
const _Tabs = Tabs;
const ElTabs = _Tabs;
const ElTabPane = script$2;

export default _Tabs;
export { ElTabPane, ElTabs };
