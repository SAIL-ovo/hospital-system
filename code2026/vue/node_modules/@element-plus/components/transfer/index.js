import { getCurrentInstance, computed, watch, defineComponent, reactive, toRefs, resolveComponent, openBlock, createBlock, createVNode, withCtx, createTextVNode, toDisplayString, createCommentVNode, withDirectives, Fragment, renderList, vShow, renderSlot, inject, ref, h } from 'vue';
import ElButton from '@element-plus/components/button';
import { elFormItemKey } from '@element-plus/tokens';
import { useLocaleInject } from '@element-plus/hooks';
import { UPDATE_MODEL_EVENT, CHANGE_EVENT } from '@element-plus/utils/constants';
export { CHANGE_EVENT } from '@element-plus/utils/constants';
import { ElCheckboxGroup, ElCheckbox } from '@element-plus/components/checkbox';
...
script$1.__file = "packages/components/transfer/src/index.vue";
