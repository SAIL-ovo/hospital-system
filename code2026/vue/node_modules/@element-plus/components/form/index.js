import { defineComponent, watch, reactive, toRefs, provide, ref, computed, openBlock, createBlock, renderSlot, inject, onMounted, onUpdated, onBeforeUnmount, nextTick, h, Fragment, getCurrentInstance, resolveComponent, createVNode, withCtx, createTextVNode, toDisplayString, createCommentVNode, Transition } from 'vue';
import mitt from 'mitt';
import { elFormEvents, elFormKey, elFormItemKey } from '@element-plus/tokens';
import AsyncValidator from 'async-validator';
import { NOOP } from '@vue/shared';
import { useGlobalConfig, addUnit, getPropByPath } from '@element-plus/utils/util';
...
var script$1 = defineComponent({
  ...
  setup(props, { slots }) {
    ...
    const getFilteredRule = (trigger) => {
      ...
      }).map((rule) => __spreadValues$1({}, rule));
    };
    const onFieldBlur = () => {
      validate("blur");
    };
    ...
    const elFormItem = reactive(__spreadProps$1(__spreadValues$1({}, toRefs(props)), {
      size: sizeClass,
      validateState,
...
script$1.__file = "packages/components/form/src/form-item.vue";

script.install = (app) => {
  app.component(script.name, script);
  app.component(script$1.name, script$1);
};
script.FormItem = script$1;
const _Form = script;
const ElForm = _Form;
const ElFormItem = script$1;
