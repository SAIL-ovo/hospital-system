import { defineComponent, ref, watch, onUnmounted, provide, openBlock, createBlock, renderSlot, inject, computed, resolveComponent, createVNode, withKeys, withModifiers, createTextVNode, toDisplayString, withCtx, withDirectives, vShow } from 'vue';
...
const _hoisted_1$1 = { class: "el-collapse-item__content" };
...
script$1.__file = "packages/components/collapse/src/collapse-item.vue";

script.install = (app) => {
  app.component(script.name, script);
  app.component(script$1.name, script$1);
};
script$1.CollapseItem = script$1;
const _Collapse = script;
const ElCollapse = _Collapse;
const ElCollapseItem = script$1;
