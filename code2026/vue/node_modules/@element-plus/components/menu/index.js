import { defineComponent, openBlock, createBlock, Transition, mergeProps, toHandlers, withCtx, renderSlot, computed, ref, getCurrentInstance, watch, provide, onMounted, isRef, resolveComponent, inject, onBeforeUnmount, createVNode, Fragment, reactive, createTextVNode, toDisplayString, onBeforeMount, h, withDirectives, vShow } from 'vue';
...
function render$3(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createBlock("li", _hoisted_1$1, [
    createVNode("div", {
