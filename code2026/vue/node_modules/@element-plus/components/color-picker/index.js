import { defineComponent, getCurrentInstance, ref, watch, onMounted, openBlock, createBlock, createVNode, computed, inject, watchEffect, Fragment, renderList, reactive, nextTick, provide, resolveComponent, resolveDirective, withCtx, withDirectives, createCommentVNode, withKeys, createTextVNode, toDisplayString, vShow } from 'vue';
...
script$1.__file = "packages/components/color-picker/src/components/hue-slider.vue";
...
const _hoisted_1$1 = /* @__PURE__ */ createVNode("div", { class: "el-color-svpanel__white" }, null, -1);
const _hoisted_2$1 = /* @__PURE__ */ createVNode("div", { class: "el-color-svpanel__black" }, null, -1);
...
script$3.__file = "packages/components/color-picker/src/components/sv-panel.vue";
